...
import { CardGiftcard, School, VolunteerActivism, HealthAndSafety, People } from "@mui/icons-material"
...
const CTASection = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      <GradientBackground>
        <Box textAlign="center" maxWidth="sm" mx="auto">
          ...
          <Typography variant="body1" color="text.secondary" paragraph>
            Join us in breaking the cycle of poverty by providing essential resources, quality education, and a
            healthier life for children. Together, we can create pathways to success and a brighter tomorrow.
          </Typography>
          <Button
            variant="contained"
            color="primary"
      ...
      {/* Donation Modal */}
      <DonationModal open={openDonationModal} handleClose={handleCloseDonationModal} />
    </Container>
  )
}
      ...
      <Container maxWidth="lg">
        <Box display="flex" flexDirection="column" gap={2}>
          ...
          <Typography variant="body1" fontSize="1.5rem" color="text.secondary">
            Everything done by the Mpumelelo Foundation is designed to provide comprehensive support, laying a strong
            foundation for children to succeed, lead, and ultimately break the cycle of poverty and inequality in their
            lives.
          </Typography>
        </Box>
            ...
            <Grid item xs={12} sm={6} key={index}>
              <Card variant="outlined" sx={{ height: "100%" }}>
                <CardContent>
                  ...
                  <Typography variant="h5" fontWeight="medium" color="text.primary" fontSize="1.4rem" mt={2}>
                    {feature.title}
                  </Typography>
                  <Typography variant="body2" fontSize="1.1rem" color="text.secondary" mt={1}>
                    {feature.description}
                  </Typography>
                  <Button
                    variant="text"
    ...
    <section>
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Box display="flex" flexDirection="column" alignItems="center">
          ...
          >
            Your support fuels essential programs that uplift children and empower communities. Join us in creating
            lasting change, one donation at a time.
          </Typography>
