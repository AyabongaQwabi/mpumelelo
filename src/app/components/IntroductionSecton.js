        ...
        <Box sx={{ flexGrow: 1, padding: 2 }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                To alleviate poverty and change lives. At Mpumelelo foundation
                we believe it takes a village to raise children. In South Africa
                a significant number of children go to bed hungry and sometimes
                struggle to afford the basic life needs such as toiletries and
                clothes. This affects their education and some end up dropping
                out of school.
              </Typography>
              <Box
                sx={{
