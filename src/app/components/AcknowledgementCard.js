import { CardMedia, Typography, CardContent, Grid, Box } from "@mui/material"
    ...
    <Box sx={{ width: "100%", backgroundColor: "white", paddingBottom: 20 }}>
      ...
      >
        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            At our foundation, we strive to make a positive impact in the lives of those in need. Your contributions
            help us provide vital resources, spread hope, and empower communities. Together, we’re changing lives. We
            are deeply grateful for the generosity of our donors who have supported our mission.
          </Typography>
        </Box>
      </Box>
          ...
          {donors.map((donor, index) => (
            <Grid item xs={12} sm={6} key={index}>
              <Box>
                ...
                >
                  <Typography sx={{ color: "white", fontSize: "1.2rem", fontWeight: "bold" }}>{donor.name}</Typography>
                </CardContent>
              </Box>
            </Grid>
          ))}
